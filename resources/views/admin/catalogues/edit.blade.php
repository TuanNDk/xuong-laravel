                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="card-title mb-0">
                            <h4>Cập nhật danh mục: <span class="text-danger ms-3 fs-3">{{ $model->name }}</span></h4>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.catalogues.update', $model->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <img id="img_danh_muc" src="{{ Storage::url($model->cover) }}"
                                ...
                                <div class="d-flex ">
                                    ...
                                    <a href="{{ route('admin.catalogues.index') }}"><i
                                        class="btn btn-success ri-arrow-go-back-fill ms-3"></i></a>
                                </div>
                            </div>
                        </form>
                    </div>
